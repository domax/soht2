...
Create a concise commit message based on the current changes in the project.
Using all the common rules, practices and approaches to generate message text.